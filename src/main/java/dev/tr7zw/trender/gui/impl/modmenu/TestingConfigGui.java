...
public class TestingConfigGui extends AbstractConfigScreen {
    public TestingConfigGui(Screen previous) {
        ...
        options.add(getEnumOption("text.trender.style", GuiStyle.class, () -> LibGuiClient.config.getConfig().style,
