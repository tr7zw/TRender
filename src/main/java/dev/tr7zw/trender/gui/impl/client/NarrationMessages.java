...
public final class NarrationMessages {
    ...
    public static final Component SCROLL_BAR_TITLE = ComponentProvider.translatable("widget.libgui.scroll_bar.narration.title");
    ...
    public static final Component TOGGLE_BUTTON_ON = ComponentProvider.translatable("widget.libgui.toggle_button.narration.on");
    public static final String TOGGLE_BUTTON_UNNAMED_KEY = "widget.libgui.toggle_button.narration.unnamed";

    public static final class Vanilla {
        public static final Component BUTTON_USAGE_FOCUSED = ComponentProvider.translatable("narration.button.usage.focused");
        public static final Component BUTTON_USAGE_HOVERED = ComponentProvider.translatable("narration.button.usage.hovered");
        public static final Component COMPONENT_LIST_USAGE = ComponentProvider.translatable("narration.component_list.usage");
