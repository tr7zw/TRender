...
public class WWidget {
    ...
    /**
     * The containing panel of this widget. Can be null if this widget is the root
     ...
     * widget is a {@linkplain dev.tr7zw.trender.gui.client.CottonHud HUD} widget.
     */
    @Nullable
     ...
     *
     * <p>
     * Overriding methods may restrict one of the dimensions to be a constant value,
     * for example {@code super.setSize(x, 20)}.
     *
     ...
     *
     * @param x      The X coordinate of the event, in widget-space (0 is the left
     *               edge of this widget)
     * @param y      The Y coordinate of the event, in widget-space (0 is the top
     *               edge of this widget)
     * @param button The mouse button that was used. Button numbering is consistent
     *               with LWJGL Mouse (0=left, 1=right, 2=mousewheel click)
     * @return {@link InputResult#PROCESSED} if the event is handled,
     *         {@link InputResult#IGNORED} otherwise.
     */
    ...
    /**
     * Notifies this widget that the mouse has been moved while pressed and inside
     * its bounds.
     *
     * @param x      The X coordinate of the event, in widget-space (0 is the left
     *               edge of this widget)
    ...
    /**
     * Notifies this widget that the mouse has been pressed and released, both while
     * inside its bounds.
     *
     * @param x      The X coordinate of the event, in widget-space (0 is the left
     *               edge of this widget)
     ...
     *
     * @param x                The X coordinate of the event, in widget-space (0 is
     *                         the left edge of this widget)
     * @param y                The Y coordinate of the event, in widget-space (0 is
     *                         the top edge of this widget)
     * @param horizontalAmount The scrolled horizontal amount. Positive values are
     *                         right and negative values are left.
     * @param verticalAmount   The scrolled vertical amount. Positive values are up
     ...
     *
     * @param x The X coordinate of the event, in widget-space (0 is the left edge
     *          of this widget)
     * @param y The Y coordinate of the event, in widget-space (0 is the top edge of
     *          this widget)
     * @return {@link InputResult#PROCESSED} if the event is handled,
     *         {@link InputResult#IGNORED} otherwise.
     * @since 1.5.0
    ...
    /**
     * Notifies this widget that a character has been typed. This method is subject
     * to key repeat, and may be called for characters that do not directly have a
     ...
     *
     * <p>
     * The default implementation checks that X and Y are at least 0 and below the
     ...
     * {@link #addTooltip(TooltipBuilder) addTooltip} method to insert data into the
     * tooltip - without this, the method returns early because of no work.
     *
     * @param context the draw context
    ...
    /**
     * Creates component peers and initializes animation data for this Widget and
     * all its children. The host
     * {@linkplain net.minecraft.world.inventory.AbstractContainerMenu screen
     * handler} must clear any heavyweight peers from its records before this method
     * is called.
     *
     * <p>
     * This method must be called on the root panel of any screen once the widgets
    ...
    /**
     * Returns the focus model of this widget. The focus model provides the
     * focusable areas of this widget, and handles switching through them.
     *
     * <p>
     * If this widget {@linkplain #canFocus() can focus}, it should return a nonnull
     * focus model. The default implementation returns {@link FocusModel#simple
    ...
    /**
     * Notifies this widget that it is visible and shows any hidden peers of itself
     * and its children.
     *
     * @since 3.0.0
     */
    ...
    /**
     * Notifies this widget that it won't be drawn and hides any visible peers of
     * itself and its children.
     *
     * <p>
     * The default implementation releases this widget's focus if it is focused.
     * Overriding implementations might want to do this as well.
     *
     * @since 3.0.0
     */
     ...
     *
     * <p>
     * Always called before {@link GuiDescription#addPainters()} to allow users to
     * modify painters.
     *
     * @since 3.0.0
     */
    ...
    /**
     * Tests whether this widget receives {@linkplain #hoveredProperty() mouse
     * hovering status}.
     *
    ...
    /**
     * Returns whether the user is hovering over this widget. The result is an
     * <i>observable property</i> that can be modified and listened to.
     *
     * <p>
    ...
    /**
     * Returns whether the user is hovering over this widget. This is equivalent to
     * calling <code>{@link #hoveredProperty()}.get()</code>.
     *
    ...
    /**
     * Sets the {@link #hoveredProperty() hovered} property. This is equivalent to
     * calling <code>{@link #hoveredProperty()}.set(<i>hovered</i>)</code>.
     *
    ...
    /**
     * Adds the narrations of this widget to a narration builder. Narrations will
     * only apply if this widget {@linkplain #isNarratable() is narratable}.
     *
     * <p>
     * The widget needs to be {@linkplain #canFocus() focusable} or
     * {@linkplain #canHover() hoverable}, and also be focused/hovered for
     * narrations to be added.
     *
