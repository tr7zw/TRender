 ...
 *
 * <p>
 * D is the type of data represented. The data must reside in some ordered
 * backing {@code List<D>}. D's *must* have working equals and hashCode methods
...
public class WListPanel<D, W extends WWidget> extends WClippedPanel {
    ...
    /**
     * The widget configurator that configures the passed widget to display the
     * passed data.
     */
     ...
     * @param configurator the widget configurator that configures widgets to
    ...
    /**
     * Gets the {@link dev.tr7zw.trender.gui.widget.WScrollBar} attached to this
     * panel.
     *
