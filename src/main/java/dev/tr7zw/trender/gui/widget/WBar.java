 ...
 *
 * <p>
 * Bars can be used for all kinds of bars including progress bars (and progress
 * arrows) and energy bars.
 */
public class WBar extends WWidget {
    /**
     * The background texture. If not null, it will be drawn behind the bar
     * contents.
     */
    @Nullable
    ...
    /**
     * The bar texture. If not null, it will be drawn to represent the current
     * field.
     */
    @Nullable
     ...
     *
     * <p>
     * If {@code max} is negative, the {@link #maxValue} constant will be used
     * instead.
     */
     ...
     *
     * <p>
     * The current value is read from the property with ID {@link #field}, and the
     * maximum value is usually read from the property with ID {@link #max}.
     */
    protected ContainerData properties;
    private boolean manuallySetProperties = false;

    /**
     * The direction of this bar, representing where the bar will grow when the
     * field increases.
     */
     ...
     * or together with it. In that case, this component will be drawn after the
     * other label.
     */
     ...
     *
     * <p>
     * Formatting Guide: The tooltip label is passed into {@code String.format} and
     * can receive two integers (%d) - the first is the current value of the bar's
     * focused field, and the second is the bar's focused maximum.
     *
    ...
    public void paint(RenderContext context, int x, int y, int mouseX, int mouseY) {
        if (bg != null) {
            ...
            ScreenDrawing.coloredRect(context, x, y, getWidth(), getHeight(),
        ...
        case UP -> {
            ...
            if (bar != null) {
                ...
                ScreenDrawing.coloredRect(context, left, top, getWidth(), barSize,
        ...
        case RIGHT -> {
            if (bar != null) {
                ...
                ScreenDrawing.coloredRect(context, x, y, barSize, getHeight(),
                        ScreenDrawing.colorAtOpacity(0xFFFFFF, 0.5f));
            }
        }
        ...
        case DOWN -> {
            if (bar != null) {
                ...
                ScreenDrawing.coloredRect(context, x, y, getWidth(), barSize,
                        ScreenDrawing.colorAtOpacity(0xFFFFFF, 0.5f));
            }
        }
        ...
        case LEFT -> {
            ...
            if (bar != null) {
                ...
                ScreenDrawing.coloredRect(context, left, top, barSize, getHeight(),
                        ScreenDrawing.colorAtOpacity(0xFFFFFF, 0.5f));
            }
        }
        }
    ...
    public void validate(GuiDescription host) {
        super.validate(host);
        if (properties == null || !manuallySetProperties)
            properties = host.getPropertyDelegate();
    }
     ...
     *
     * <p>
     * This method is meant for situations when a GUI description is unavailable
     * (such as HUDs). {@link GuiDescription#getPropertyDelegate()} should be
     * preferred over this if available.
     *
    ...
    /**
     * Creates a WBar that has a constant maximum-value instead of getting the
     * maximum from a field.
     *
    ...
    /**
     * The direction of a {@link WBar}, representing where the bar will grown when
     * its field increases.
     */
