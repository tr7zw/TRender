...
public abstract class WPanelWithInsets extends WPanel {
    /**
     * The layout insets of this panel. They control how far from the panel's edges
    ...
    /**
     * Sets the layout insets of this panel. Subclasses are encouraged to override
     * this method to return their more specific type (such as {@link WGridPanel}).
     *
     * <p>
     * If there are already widgets in this panel when the insets are modified, the
     * panel is resized and the widgets are moved according to the insets.
     *
