...
public interface Color {
    ...
    Color[] DYE_COLORS = { WHITE_DYE, ORANGE_DYE, MAGENTA_DYE, LIGHT_BLUE_DYE, YELLOW_DYE, LIME_DYE, PINK_DYE, GRAY_DYE,
    ...
    public static class RGB implements Color {
        ...
        /**
         * Gets the chroma value, which is related to the length of the vector in
         * projected (hexagonal) space.
         */
        ...
        public int getHue() {
            ...
            if (max >= r)
                return (int) ((((g - b) / chroma) % 6) * 60);
            if (max >= g)
                return (int) ((((b - r) / chroma) + 2) * 60);
            if (max >= b)
                return (int) ((((r - g) / chroma) + 4) * 60);
        ...
        /**
         * Gets the saturation for this color based on chrominance and HSL
         * <em>luma</em>.
         */
         ...
         * When t = 1.0, endVal is returned. Eg.: If this color is black, your endColor
         * is white and t = 0.5 you get gray.
         *
