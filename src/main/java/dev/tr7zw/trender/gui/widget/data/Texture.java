 ...
 * <h2>Types</h2>
 * <p>
 * Each texture has a type: it's either a {@linkplain Type#STANDALONE standalone
 * texture file} or a {@linkplain Type#GUI_SPRITE sprite on the GUI sprite
 * atlas}. Their properties are slightly different.
 *
 * <p>
 * GUI sprites can use their full range of features such as tiling, stretching
 * and nine-slice drawing modes, while standalone textures are only drawn
 * stretched.
 *
 * <p>
 * The format of the image ID depends on the type. See the documentation of the
 * individual type constants and the table below for details.
 * <table>
 * <caption>Image IDs for each texture type</caption> <thead>
 * <tr>
 * <th>Type</th>
 * <th>File path</th>
 * <th>Image ID</th>
 ...
 * <code>{@link dev.tr7zw.trender.gui.client.ScreenDrawing ScreenDrawing}.texturedRect()</code>
...
public record Texture(/*? >= 1.21.11 {*/ Identifier /*?} else {*//* ResourceLocation *//*?}*/ image, Type type,
    ...
    public enum Type {
         ...
         *
         * <p>
         * The image IDs of standalone textures contain the full file path to the
         * texture inside the {@code assets/<namespace>} directory. For example,
         * {@code my_mod:textures/widget/example.png} refers to
         ...
         *
         * <p>
         * The image IDs of GUI sprites only contain the subpath to the texture inside
         * the sprite directory without the file extension. For example,
         * {@code my_mod:example} refers to
