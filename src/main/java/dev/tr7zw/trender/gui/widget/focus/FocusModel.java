 ...
 * instance should be specific to one widget.
 *
...
public interface FocusModel<K> {
    /**
     * Checks if a focus is focused in the target widget. If the target widget is
     * not focused itself, none of its foci should have focus.
     *
     ...
     *
     * <p>
     * This method does not need to {@linkplain WWidget#requestFocus request the
     * GUI's focus} for the widget; that is the responsibility of the caller.
     *
    ...
    /**
     * Creates a simple focus model for a focusable widget. The focus model provides
     * the whole widget area as its only focus area.
     *
