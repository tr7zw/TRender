 ...
 * values that can be modified and listened to.
 *
 * <p>
 * The naming convention for {@code ObservableProperty} getters follows the
 * convention {@code <property name>Property}. For example, the
 * {@code WWidget.hovered} property can be retrieved with
 * {@link dev.tr7zw.trender.gui.widget.WWidget#hoveredProperty()
 * hoveredProperty()}.
 *
...
public final class ObservableProperty<T> implements ObservableView<T> {
    ...
    /**
     * Creates a "late init" property without an initial value. The created property
     * will throw an exception if it has not been initialised yet.
     *
     * @param <T> the contained value type
    ...
    /**
     * Returns a read-only view of this property. The result is not an instance of
     * {@link ObservableProperty}, and thus can't be mutated.
     *
