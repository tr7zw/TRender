...
/**
 * Specifies whether an input event was ignored or processed. Used for mouse and
...
public enum InputResult {
    ...
    /**
     * Combines this input result with another. The combination is
     * {@link #PROCESSED} is at least one of the inputs is.
     *
