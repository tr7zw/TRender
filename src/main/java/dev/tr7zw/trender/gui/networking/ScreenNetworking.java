 ...
 *
 * <h2>Registering a message receiver</h2> {@linkplain MessageReceiver Message
 * receivers} can be registered by calling {@link #receive} on a
 * {@code ScreenNetworking} for the receiving side. The {@code message} ID is a
 * unique ID that matches between the sender and the receiver.
 *
 * <p>
 * Message receivers should be registered in the constructor of a
 * {@link SyncedGuiDescription}.
 *
 * <h2>Sending messages</h2> Messages can be sent by calling {@link #send} on a
 * {@code ScreenNetworking} for the sending side. The message ID and codec
 * should match up with a receiver registered on the <i>opposite</i> side.
 *
 * <h2>Example</h2>
 * {@snippet :
...
public interface ScreenNetworking {
    /**
     * Gets a networking handler for the GUI description that is active on the
     * specified side.
     *
     ...
     *
     * <p>
     * The decoder can depend on registry data and
     * {@link net.minecraft.resources.RegistryOps} is available.
     *
     ...
     *
     * <p>
     * The encoder can depend on registry data and
     * {@link net.minecraft.resources.RegistryOps} is available.
     *
     * @param message the screen message ID
